  ...
  <div class="d-flex flex-column flex-grow-1">
    ...
    <header class="py-2 shadow-sm">
      <div class="container-fluid d-flex align-items-center justify-content-between">
        <h1 class="h3 mb-0 fw-bold">Student Finance Assistant</h1>
    ...
    <main class="flex-grow-1 p-4">
      <section class="container mb-5">
        <div class="text-center mb-4">
          <h2 class="fw-bold">Welcome to Student Finance Assistant</h2>
          <p class="text-muted">Manage your finances, track expenses, and achieve your financial goals with ease.</p>
        </div>
          ...
          <div class="col-md-4">
            <div class="card text-center shadow-sm">
              <div class="card-body">
                ...
                <p class="card-text">Track your monthly budget and expenses.</p>
                <a href="budget.html" class="btn btn-primary">View Budget</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="card text-center shadow-sm">
              <div class="card-body">
                ...
                <p class="card-text">Log and categorize your expenses.</p>
                <a href="track_expenses.html" class="btn btn-primary">Track Expenses</a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-12">
            <div class="card shadow-sm">
              <div class="card-body">
                ...
                <p class="card-text">Visualize your spending patterns with charts and graphs.</p>
                <a href="dashboard.html" class="btn btn-success">View Insights</a>
              </div>
            </div>
          </div>
        </div>
